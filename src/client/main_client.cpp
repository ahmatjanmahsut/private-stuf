...
void print_usage() {
    std::cout
        << "Usage: vpn_client [config_path] [--config <path>] [--web-ui] [--no-web-ui]\\n"
...
int main(int argc, char* argv[]) {
    ...
    vpn::Logger::init("vpn-client", cfg.log_level);
    VPN_INFO("VPN Client starting, config: {}", options.config_path);
    if (!config_loaded) {
